###
#   twitch-helper/twitch-helper-v2
# 
#
...
# TODO LIST
#   > System Tray Menu
#   > Check Events at set intravals and handle results
#       > If new event add it to the event list and update html file
#       ? Does OBS refresh when an html file is updated, can we do it seamless?
#       ? How much javascript am I going to have to deal with.
#       ? Should I just learn node.js and javascript -.-
